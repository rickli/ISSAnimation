...
typedef enum{
    AnimatorTypeBricks = 0,
    AnimatorTypeGhost,
    AnimatorTypeHorizontal,
    AnimatorTypeVertical,
}AnimatorType;

@interface ISSAnimationEffect : NSObject<UIViewControllerAnimatedTransitioning>
@property AnimatorType type;
